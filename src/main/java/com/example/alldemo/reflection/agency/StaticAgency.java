package com.example.alldemo.reflection.agency;
/**
 * 静态代理举例
 *
...
//代理类
class StaticAgency implements ClothFactory{
    private ClothFactory factory;//用被代理类对象进行实例化

    public StaticAgency(ClothFactory factory){
...
class NeckTest implements ClothFactory{
    ...
    public static void main(String[] args) {
        ...
        //创建代理类的对象
        ClothFactory proxyPaperFactory = new StaticAgency(word);
